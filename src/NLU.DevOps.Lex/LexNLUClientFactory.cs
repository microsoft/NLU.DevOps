...
namespace NLU.DevOps.Lex
{
    ...
    /// </summary>
    [Export("lex", typeof(INLUClientFactory))]
    public class LexNLUClientFactory : INLUClientFactory
    {
        ...
        /// </summary>
        private static readonly string LexBotNameConfigurationKey = CamelCase(nameof(LexNLUTrainClient.LexBotName));

        /// <summary>
        /// The Lex bot alias configuration key.
        /// </summary>
        private static readonly string LexBotAliasConfigurationKey = CamelCase(nameof(LexNLUTrainClient.LexBotAlias));
