...
namespace NLU.DevOps.Core
{
    ...
    /// <summary>
    /// Base class for NLU service implementation.
    /// </summary>
    /// <typeparam name="TQuery">Type of test query.</typeparam>
    public abstract class NLUServiceBase<TQuery> : INLUService
        where TQuery : INLUQuery
    {
        /// <inheritdoc />
        public abstract Task TrainAsync(IEnumerable<LabeledUtterance> utterances, CancellationToken cancellationToken);
        ...
        /// <inheritdoc />
        public abstract Task CleanupAsync(CancellationToken cancellationToken);
