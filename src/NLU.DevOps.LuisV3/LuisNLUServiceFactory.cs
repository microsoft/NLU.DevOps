...
namespace NLU.DevOps.Luis
{
    ...
    /// </summary>
    [Export("luisV3", typeof(INLUServiceFactory))]
    public class LuisNLUServiceFactory : INLUServiceFactory
    {
        ...
        private const string LuisVersionIdPrefixConfigurationKey = "luisVersionIdPrefix";
        ...
        public INLUService CreateInstance(IConfiguration configuration, string settingsPath)
        {
            ...
            slotName = versionId == null ? slotName ?? "prod" : slotName;
        ...
        private static string GetVersionId(IConfiguration configuration)
        {
            ...
            var versionIdPrefix = configuration[LuisVersionIdPrefixConfigurationKey];
